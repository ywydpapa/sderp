...
public class ProductdataDTO {
	private Integer productDataNo;		// 상품 번호
	private Integer compNo;				// 회사 구분 번호
	private Integer custNo;				// 거래처 번호
	private Integer productNo;			// 카테고리 번호
	private String productModel;	// 상품 모델명
	private String productPrice;	// 상품 가격
	private String productType;		// 상품 가격 데이터 타입
	private Integer regUser;			// 등록/수정 유저
