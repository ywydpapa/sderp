              ...
              <tr>
                ...
                <td>
                  <div class="input-group input-group-sm mb-0">
                    ...
                    />
                    <span class="input-group-btn">
                      <button class="btn btn-primary sch-company btn-sm" type="button">
                        <i class="icofont icofont-search"></i>
                      </button>
                    </span>
                  </div>
              ...
              <tr>
                ...
                <td>
                  <div class="input-group input-group-sm mb-0 col-sm-12 m-l-0 p-l-0 f-left">
                    ...
                    />
                    <label class="form-control-sm m-l-5" for=""> 일</label>
                    <div class="border-checkbox-section col-sm-3 f-left m-b-0 m-t-5 m-l-10">
                      <div
                        class="border-checkbox-group border-checkbox-group-primary m-b-0 col-sm-4 f-left m-l-0 p-l-0"
                      >
              ...
              <tr>
                ...
                <td colspan="3">
                  <div class="border-checkbox-section col-sm-6 f-left m-b-0 m-t-5 p-l-0">
                    <div
                      class="border-checkbox-group border-checkbox-group-primary m-b-0 col-sm-6 f-left m-l-0 p-l-0"
                    >
                      <input class="border-checkbox" type="checkbox" id="checkbox1" />
  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="btn_wr text-right">
        <button href="#" class="btn btn-sm btn-primary f-left">
          <i class="icofont icofont-plus"></i>상품추가
        </button>
      </div>
      <div class="prd_add">
        <ul>
          ...
          <li>
            ...
            <div class="btn_wr text-right">
              <button class="btn btn-sm btn-inverse btn-outline-inverse">
                <i class="icofont icofont-close m-0"></i>
              </button>
            </div>
          </li>
          <!--//상품추가 버튼 클릭시 li가 추가됨-->
