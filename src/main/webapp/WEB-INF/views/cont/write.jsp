...
<html>
  ...
  <div id="main_content">
                          ...
                          <div class="radio radio-inline">
                            <label style="margin-top: 10px">
                              <input
                                ...
                                checked="checked"
                              />
                              <i class="helper"></i>판매계약</label
                            >
                          </div>
                          <div class="radio radio-inline">
                            <label>
                              <input type="radio" name="contractType" value="OLD" />
                              <i class="helper"></i>유지보수</label
                            >
                          </div>
                        </form>
                      </div>
                  ...
                  <tr>
                      ...
                      <div class="input-group input-group-sm mb-0">
                        ...
                        >
                          ...
                          <c:forEach var="row" items="${listCustMember}">
                            <option data-no="${row.custData03no}" value="${row.custMname}">
                              ${row.custMname}
                            </option>
                          </c:forEach>
                        </select>
                        ...
                        <span class="input-group-btn">
                          <button
                            class="btn btn-primary sch-company btn-sm"
                            data-remote="${path}/modal/popup.do?popId=custmem&compNo="
                            type="button"
                            data-toggle="modal"
                            data-target="#custmemberModal"
                            ...
                            <div class="modal-content modal-80size">
                              <div class="modal-header">
                                ...
                                <button
                                  type="button"
                                  class="close"
                                  onclick="$('#custmemberModal').modal('hide');"
                                  aria-label="Close"
                                >
                                  <span aria-hidden="true">&times;</span>
                                </button>
                    ...
                    <td>
                      <div class="input-group input-group-sm mb-0">
                        ...
                        <span class="input-group-btn">
                          <button
                            class="btn btn-primary sch-partner"
                            data-remote="${path}/modal/popup.do?popId=endCust"
                            type="button"
                            data-toggle="modal"
                            data-target="#endCustModal"
                          >
                            <i class="icofont icofont-search"></i>
                          </button>
                        </span>
                            ...
                            <div class="modal-content modal-80size">
                              <div class="modal-header">
                                ...
                                <button
                                  type="button"
                                  class="close"
                                  onclick="$('#endCustModal').modal('hide');"
                                  aria-label="Close"
                                >
                                  <span aria-hidden="true">&times;</span>
                                </button>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="input-group input-group-sm mb-0">
                        <select
                          class="form-control"
                          id="endCustmemberName"
                          name="endCustmemberName"
                          onchange="autoCompleteSelect(this);"
                        >
                          <option value="">선택</option>
                          <c:forEach var="row" items="${listCustMember}">
                        ...
                        <span class="input-group-btn">
                          <button
                            class="btn btn-primary sch-company btn-sm"
                            data-remote="${path}/modal/popup.do?popId=endCustmem&compNo="
                            type="button"
                            data-toggle="modal"
                            data-target="#endCustmemberModal"
                            id="endCustmemberModalbtn"
                            data-whatever=""
                          >
                            <i class="icofont icofont-search"></i>
                          </button>
                            ...
                            <div class="modal-content modal-80size">
                              <div class="modal-header">
                                ...
                                <button
                                  type="button"
                                  class="close"
                                  onclick="$('#endCustmemberModal').modal('hide');"
                                  aria-label="Close"
                                >
                                  <span aria-hidden="true">&times;</span>
                                </button>
                    ...
                    <td class="contDetailSopp">
                      <div class="input-group input-group-sm mb-0">
                        <input
                          class="form-control form-control-sm col-sm-6 m-r-5"
                          type="date"
                          max="9999-12-30"
                          id="freemaintSdate"
                        />
                        ~
                        <input
                          class="form-control form-control-sm col-sm-6 m-l-5"
                          type="date"
                          max="9999-12-31"
                          id="freemaintEdate"
                        />
                      ...
                      <div class="input-group m-0 productInputDiv">
                        ...
                        <select id="productName" name="productName" onchange="productSelect(this);">
                          ...
                          <c:forEach var="row" items="${listProduct}">
                            <option data-no="${row.productNo}" value="${row.custName}">
                              ${row.productName}(${row.custName})
                            </option>
                          </c:forEach>
                        </select>
                        <div class="input-group m-0" style="display: none; width: 20%">
                          <input
                            ...
                            class="form-control"
                            id="inputText"
                            placeholder="제품에 대한 회사명을 입력해주세요."
                          />
                          <button
                            type="button"
                            class="btn btn-sm btn-primary"
                            onclick="inputSelect(this);"
                          >
                            추가
                          </button>
                        </div>
                        <div
                          class="form-control text-break w-100 categories"
                          style="display: block; word-break: break-all; white-space: normal"
                        ></div>
                      </div>
                    </td>
                  </tr>
    ...
    <div class="btn_wr text-right mt-3">
      ...
      <button class="btn btn-md btn-inverse" onClick="javascript:location='${path}/cont/list.do'">
        취소
      </button>
    </div>
    <!--//계약등록-->
    ...
    <script>
      ...
      function fn_SaveCont() {
        ...
        var net_profit =
          typeof $("#netprofit").val() === "undefined"
            ? 0
            : Number($("#netprofit").val()).replace(/[\D\s\._\-]+/g, ""); // 매출이익
        if (net_profit >= 0) {
        ...
        if ($("#custmemberName").val() != "")
          contData.custmemberNo = Number($("#custmemberNo").val()); // 거래처 담당자
        if ($("#endCustName").val() != "") contData.buyrNo = Number($("#endCustNo").val()); // 엔드유저
        if ($("#endCustmemberName").val() != "")
          contData.buyrMemberNo = Number($("#endCustmemberNo").val()); // 엔드유저 담당자
