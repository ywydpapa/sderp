...
<body>
	...
	<div style="width:100%;">
		<button type="button" onclick="solPdf();" style="border: 0; background-color: #312D85; color: #fff; text-align:center; width: 30%; height:44px; cursor: pointer;">PDF파일 저장</button>
	</div>
</body>
<script>
function solPdf(){  
