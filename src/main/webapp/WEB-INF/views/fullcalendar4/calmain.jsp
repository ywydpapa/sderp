    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <table class="table table-sm bst02">
          ...
          <tbody>
            <tr>
              <td><label class="col-xs-4" for="edit-type">일정구분</label></td>
              <td>
                <select class="inputCat" name="schedCat" id="schedCat">
            ...
            <tr>
              ...
              <td>
                <label class="col-xs-4" for="schedAllday"></label
                ><input class="allDayNewEvent" id="schedAllday" type="checkbox" />
              </td>
            </tr>
            <tr>
              <td><label class="col-xs-4" for="edit-type">활동형태</label></td>
              <td>
                <select class="inputCat" name="schedType" id="schedType">
            ...
            <tr>
              ...
              <td>
                <input class="" type="text" name="schedTitle" id="schedTitle" required="required" />
            ...
            <tr>
              ...
              <td>
                <input class="" type="text" name="schedPlace" id="schedPlace" required="required" />
              </td>
            </tr>
            <tr>
              <td><label class="col-xs-4" for="schedFrom">일정시작</label></td>
              <td><input class="" type="datetime-local" name="schedFrom" id="schedFrom" /></td>
            </tr>
            <tr>
              <td><label class="col-xs-4" for="schedTo">일정종료</label></td>
              <td><input class="" type="datetime-local" name="schedTo" id="schedTo" /></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                <select class="inputModal" name="color" id="schedColor">
  ...
  var newEvent = function (start, end, schedCat) {
    ...
    $("#save-event").on("click", function () {
      ...
      if (schedAllday.is(":checked")) {
        schedData.schedFrom = moment(schedData.schedFrom).format("YYYY-MM-DD HH:mm");
        //render시 날짜표기수정
        schedData.schedTo = moment(schedData.schedTo).add(1, "days").format("YYYY-MM-DD HH:mm");
        //DB에 넣을때(선택)
        realEndDay = moment(schedData.schedTo).format("YYYY-MM-DD HH:mm");
