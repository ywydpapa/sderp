...
<div id="main_content">
    ...
    <div class="btn_wr text-right mt-3">
        <button class="btn btn-md btn-success f-left" onClick="javascript:location='${path}/gw/purlist.do'">결재목록</button>
        ...
        <button class="btn btn-md btn-inverse" onClick="javascript:location='${path}/gw/purlist.do'">취소</button>
    </div><!-- list.do -->
    <!--//계약등록-->
