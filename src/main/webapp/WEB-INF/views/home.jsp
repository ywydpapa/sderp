        ...
        <nav>
              ...
              <ul class="pcoded-submenu">
                <li class="pcoded-hasmenu">
                  <a href="${path}/sched/list.do">
                    ...
                    <span class="pcoded-mtext" data-i18n="nav.menu-levels.menu-level-21"
                      >일정조회</span
                    >
                    <span class="pcoded-mcaret"></span>
                  </a>
                ...
                <li class="">
                  <a href="${path}/sched/write.do">
                    ...
                    <span class="pcoded-mtext" data-i18n="nav.menu-levels.menu-level-22"
                      >일정등록</span
                    >
                    <span class="pcoded-mcaret"></span>
                  </a>
          ...
          <ul class="pcoded-item pcoded-left-item">
            ...
            <li class="">
              <a href="#">
                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                <span class="pcoded-mtext" data-i18n="nav.menu-levels.menu-level-23"
                  >사용자 설정</span
                >
                <span class="pcoded-mcaret"></span>
              </a>
