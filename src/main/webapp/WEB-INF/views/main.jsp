...
<html>
  <head>
    <title>BizCore 2024.03.15</title>
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="${path}/assets/icon/themify-icons/themify-icons.css"
    />
    <!-- ico font -->
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="${path}/assets/icon/simple-line-icons/css/simple-line-icons.css"
    />
    <!-- font-awesome-->
    <link
      rel="stylesheet"
      type="text/css"
      href="${path}/assets/icon/font-awesome/css/font-awesome.min.css"
    />
    <!-- Style.css -->
    <link
      rel="stylesheet"
      type="text/css"
      href="${path}/assets/css/bootstrap/css/bootstrap.min.css"
    />
    <!-- CSS only -->
  ...
  <body style="overflow-y: scroll">
    <% String userId = ""; if ((String) session.getAttribute("userId") != null) { userId = (String)
    session.getAttribute("userId"); } String userName = ""; if ((String)
    session.getAttribute("userName") != null) { userName = (String)
    session.getAttribute("userName"); } String userRole = ""; if ((String)
    session.getAttribute("userRole") != null) { userRole = (String)
    session.getAttribute("userRole"); } String compNo = ""; if ((String)
    session.getAttribute("compNo") != null) { compNo = (String) session.getAttribute("compNo"); } %>
          ...
          <div class="navbar-wrapper">
            <div class="navbar-logo">
              ...
              <a href="${path}/">
                <img
                  class="img-fluid"
                  src="${path}/assets/images/auth/logo_008.png"
                  alt="Theme-Logo"
            ...
            <div class="navbar-container container-fluid">
              ...
              <ul class="nav-right">
                ...
                <li class="user-profile header-notification">
                  <a href="#!">
                    <img
                      src="${path}/assets/images/avatar-blank.jpg"
                      class="img-radius"
                  ...
                  <ul class="show-notification profile-notification">
                    <li>
                      <a href="${path}/user/login.do"> <i class="ti-email"></i> 로그인 </a>
                    </li>
                  </ul>
                </li>
                <%}else{%>
                <li class="user-profile header-notification">
                  ...
                  <ul class="show-notification profile-notification">
                    <il>
                      <a href="#userInfoChangeModal" data-toggle="modal">
                        <i class="ti-user ti-layout-sidebar-left"></i>개인정보수정</a
                      >
                    </il>
                    <il>
                        ...
                        <div class="modal-content modal-80size">
                          ...
                          <div class="modal-footer">
                            <button
                              ...
                              onclick="javascript:fnChangeInfo()"
                            >
                              비밀번호 수정
                            </button>
                            <button
