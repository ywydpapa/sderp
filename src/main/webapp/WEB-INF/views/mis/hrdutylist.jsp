<%-- Created by IntelliJ IDEA. User: djkim Date: 2022-04-04 Time: 오전 9:29 To change this template
...
prefix="c"%> <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt"%> <%@ taglib
                  ...
                  <c:forEach var="row" items="${dutyList}">
                    <tr>
                      <td class="text-center">
                        <a
                          data-remote="${path}/modal/popup.do?popId=user_data&userName=${row.userName}"
                          data-toggle="modal"
