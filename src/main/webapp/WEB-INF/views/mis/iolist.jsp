          ...
          <div class="col-lg-12">
            ...
            <div class="btn_wr" style="float: right">
              ...
              <button
                ...
                onClick="javascript:location='${path}/cont/iolistall.do'"
              >
                <i class="icofont icofont-pencil-alt-2"></i>개별목록 확인
              </button>
              ...
              <button
                ...
                onClick="javascript:location='${path}/cont/iowrite.do/0'"
              >
                <i class="icofont icofont-pencil-alt-2"></i>자료등록
              </button>
            </div>
          </div>
        </div>
                ...
                <tbody>
                  <c:forEach var="row" items="${listsum}">
                    <tr>
                      ...
                      <td class="text-right">
                        <fmt:formatNumber type="number" maxFractionDigits="3" value="${row.take}" />
                      </td>
                      <td class="text-right" id="absSum">
                        <fmt:formatNumber
                          type="number"
                          maxFractionDigits="3"
                          value="${row.take-row.amount}"
                        />
                      </td>
                      <td></td>
                    </tr>
