...
<form name="form2" method="post" onsubmit="return false;">
    ...
    <table class="table table-sm bst02" id="addquty">
        ...
        <thead>
        <tr>
            <th class="text-center">휴가종류</th>
            <th class="text-center">휴가시작일</th>
            <th class="text-center">휴가종료일</th>
            <th class="text-center">잔여휴가</th>
            <th class="text-center">삭제</th>
        </tr>
        </thead>
        <tbody>
            <tr class="item1">
                <td><select class="form-control form-control-sm" id="hrType" style="min-width: 80px;"></select></td>
                ...
                <td><input type="number" class="form-control form-control-sm" id="hrRest" style="min-width: 80px;" /></td>
                <td rowspan="2">
                    <button id="HRAddbtn" class="btn btn-success btn-sm" onClick="dataSave();">추가</button>
                    <button id="HRModbtn" class="btn btn-instagram btn-sm" onClick="javascript:fn_data02Update()">수정</button>
                </td>
            </tr>
            <tr>
            	<td colspan="4">
	            	<textarea rows="5" id="data02Spec" class="form-control form-control-sm" placeholder="추가기재사항을 입력해주세요."></textarea>
            	</td>
            </tr>
        </tbody>
    </table>
