  ...
  <table class="table table-sm bst02" id="addquty">
    ...
    <tbody>
      <tr class="item1">
        ...
        <td>
          <div class="input-group input-group-sm mb-0">
            ...
            <span class="input-group-btn">
              <button
                class="btn btn-primary sch-company"
                onclick="fn_productdataTableReload2()"
                type="button"
                data-toggle="modal"
                data-target="#productdataModal2"
              >
                <i class="icofont icofont-search"></i>
              </button>
            </span>
        ...
        <td>
          <input type="text" class="form-control form-control-sm" id="data02Discount"
          style="min-width: 80px;" value="<fmt:formatNumber value="1.0" type="percent" />" />
        </td>
        ...
        <td>
          <button
            ...
            onClick="javascript:fn_data02Insert()"
          >
            추가
          </button>
          <button
...
<script>
  ...
  function fn_data02Insert() {
    ...
    if ($("#productSalesEstimateCustName").val() != "")
      data02Data.salesCustNo = Number($("#productSalesEstimateCustNo").val());
    if ($("#data02Title").val() != "") {
    ...
    data02Data.dataNetprice = $("#data02Netprice")
      .val()
      .replace(/[\D\s\._\-]+/g, "");
    data02Data.dataQuanty = $("#data02Quanty")
      .val()
      .replace(/[\D\s\._\-]+/g, "");
    data02Data.dataAmt = $("#data02Amt")
      .val()
      .replace(/[\D\s\._\-]+/g, "");
    data02Data.dataVat = $("#data02Vat")
      .val()
      .replace(/[\D\s\._\-]+/g, "");
    data02Data.dataTotal = $("#data02Total")
      .val()
      .replace(/[\D\s\._\-]+/g, "");
    data02Data.dataDiscount =
      $("#data02Discount")
        .val()
        .replace(/[\D\s\._\-]+/g, "") / 100;
