...
<script>
  ...
  $(document).on("click", "#dataDelBtn", function () {
    ...
    var calAmount =
      parseInt($("#amountSum").val()) -
      parseInt(dataArray[$(this).attr("data-index")].productAmount);
    var calVat =
      parseInt($("#vatSum").val()) - parseInt(dataArray[$(this).attr("data-index")].productVat);
  ...
  function dataUpdateBtn(event) {
    ...
    if ($(event).attr("data-flag") == 1) {
      ...
      addquty
        .find("#productSalesEstimateCustName")
        .val($(event).parents("tr").find("#salesCustNoN").html())
        .trigger("change");
      addquty
        .find("#productSalesEstimateCustNo")
        .val($(event).parents("tr").find("#productCustNo").val());
      ...
      if ($(event).parents("tr").find("#productNo").val() === "") {
        ...
        addquty
          .find("#data02Title[data-flag='true']")
          .val($(event).parents("tr").find("#dataTitle").html());
      } else {
        $("#select1").show();
  ...
  function dataItemUpdate() {
    if ($("#itemKinds").val() === "") {
      ...
      var calTotal =
        parseInt(
          $("#product02InSum_table")
            .html()
            .replace(/[\D\s\._\-]+/g, "")
        ) - parseInt(dataArray[flagIndex].productTotal);
      var calAmount =
        parseInt($("#amountSum").val()) - parseInt(dataArray[flagIndex].productAmount);
      ...
      FlagQutyList.find("#dataNetprice").html(
  ...
  function dataSave() {
    if ($("#itemKinds").val() === "") {
      ...
      qutylist.append(
        "<tr><td id='dataItemKinds' style='text-align:center;'>" +
          itemKinds +
          "</td><td id='dataItemTitle' style='text-align:center;'>" +
          itemTitle +
          ...
          "</td><td id='dataRemark'>" +
          productRemark +
          "</td><td id='dataSpec' style='display:none;'>" +
          productSpec +
          "</td><td style='text-align:center;'><button class='btn btn-sm btn-inverse' id='dataUpdateBtn' data-flag='1' data-index=" +
          dataIndex +
          " onClick='dataUpdateBtn(this);'>수정</button></td><td style='text-align:center;'><button class='btn btn-sm btn-danger' data-index=" +
          dataIndex +
  ...
  function fn_data02Insert() {
    ...
    if ($("#estTitle").val() === "") {
      ...
      data02Data.estTotal = $("#product02InSum_table")
        .html()
        .replace(/[\D\s\._\-]+/g, "");
