  ...
  <table class="table table-sm bst02" id="addinout">
    ...
    <tbody>
      <tr class="item1">
        ...
        <td>
          <input type="date" max="9999-12-30" id="ioDate" name="inDate" />
        </td>
        <td>
          <div class="input-group input-group-sm mb-0">
            ...
            <span class="input-group-btn">
              <button
                ...
                data-remote="${path}/modal/popup.do?popId=productdataListSalesInOutCust"
                type="button"
                data-toggle="modal"
                data-target="#productCustModal2"
              >
              ...
              <div class="modal-dialog modal-80size" role="document">
                <div class="modal-content modal-80size">
                  ...
                  <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success waves-effect" id="custRegSimple1">
                      간편추가
                    </button>
                  </div>
                  <div
                        ...
                        <tr>
                          ...
                          <td>
                            <button
                              ...
                              id="custRegSimple_custName_check1"
                            >
                              중복확인
                            </button>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <input
                              type="text"
                              value=""
                              id="custRegSimple_custMemerName1"
                              style="width: 100%"
                          ...
                          <td>
                            <button
                              ...
                              id="custRegSimple_custName_register1"
                            >
                              등록
                            </button>
                          </td>
            ...
            <div id="select1">
              <div class="input-group input-group-sm mb-0">
                ...
                <span class="input-group-btn">
                  <button
                    class="btn btn-primary sch-company"
                    onclick="fn_productdataTableReload()"
                    type="button"
                    data-toggle="modal"
                    data-target="#productdataModal1"
                  >
                    <i class="icofont icofont-search"></i>
                  </button>
                </span>
                ...
                <div class="modal-dialog modal-80size" role="document">
                  <div class="modal-content modal-80size">
                    ...
                    <div class="modal-footer">
                      ...
                      <%--
                      <button type="button" class="btn btn-success waves-effect" id="productReg">
                        상품추가</button
                      >--%> <%--
                      <button
                        type="button"
                        class="btn btn-success waves-effect"
                        id="productRegSimple1"
                      >
                        직접기입</button
                      >--%>
                    </div>
          ...
          <div id="vatBdiv">
            <div class="input-group input-group-sm mb-0">
              ...
              <span class="input-group-btn">
                <button
                  class="btn btn-primary sch-company"
                  data-remote="${path}/modal/popup.do?popId=vatB"
                  type="button"
                  data-toggle="modal"
                  data-target="#vatBModal"
                >
                  <i class="icofont icofont-search"></i>
                </button>
              </span>
          ...
          <div id="vatSdiv">
            <div class="input-group input-group-sm mb-0">
              ...
              <span class="input-group-btn">
                <button
                  class="btn btn-primary sch-company"
                  data-remote="${path}/modal/popup.do?popId=vatS"
                  type="button"
                  data-toggle="modal"
                  data-target="#vatSModal"
                >
                  <i class="icofont icofont-search"></i>
                </button>
              </span>
        ...
        <td>
          <button
            ...
            onClick="javascript:fn_data01Insert()"
          >
            추가
          </button>
          <button
            ...
            onClick="javascript:fn_data01Update()"
          >
            수정
          </button>
        </td>
...
<script>
  ...
  function fn_data01Insert() {
    ...
    if ($("#productSalesInOutCustName").val() != "")
      data01Data.salesCustNo = Number($("#productSalesInOutCustNo").val());
    ...
    data01Data.dataNetprice = $("#data01Netprice")
      .val()
      .replace(/[\D\s\._\-]+/g, "");
    data01Data.dataQuanty = $("#data01Quanty")
      .val()
      .replace(/[\D\s\._\-]+/g, "");
    data01Data.dataAmt = $("#data01Amt")
      .val()
      .replace(/[\D\s\._\-]+/g, "");
    data01Data.dataVat = $("#data01Vat")
      .val()
      .replace(/[\D\s\._\-]+/g, "");
    data01Data.dataTotal = $("#data01Total")
      .val()
      .replace(/[\D\s\._\-]+/g, "");
  ...
  function fn_data01Update() {
    ...
    $.ajax({
      url: "${path}/sopp/updatedata01.do", // 클라이언트가 HTTP 요청을 보낼 서버의 URL 주소
      data: data01Data, // HTTP 요청과 함께 서버로 보낼 데이터
      method: "POST", // HTTP 요청 메소드(GET, POST 등)
      dataType: "json", // 서버에서 보내줄 데이터의 타입
    }) // HTTP 요청이 성공하면 요청한 데이터가 done() 메소드로 전달됨. .
