		...
		$(function(){
			...
			noticeTable = $('#noticeTable').DataTable({
				...
				fnServerParams : function (data){
					...
					data.push({"name":"noticeType", "value" : $("#noticeType option:selected").val()});
					if($("#targetDatefrom").val() != "" && $("#targetDateto").val() != ""){
						data.push({"name":"noticeFrdatetime", "value" : $("#noticeFrdatetime").val()});
						data.push({"name":"noticeTodatetime", "value" : $("#noticeTodatetime").val()});
					} else {
						data.push({"name":"noticeFrdatetime", "value" : ""});
						data.push({"name":"noticeTodatetime", "value" : ""});
					}
					...
					},
					{
						...
						render : function ( data, type, row ) {
							if(data == null || data == undefined) {
								...
								return '<a href="javascript:fnSetPageEx(\''+row.noticeNo+'\')" title="'+data+'">'+data+'</a>';
							}
						},
					},
					{
						data: "noticeFrdatetime",
						column : '영업활동(시작)',
						render : function ( data, type, row ) {
							if(data == null || data == undefined) {
								return '';
						...
						<div class="card_box sch_it">
							...
							<div class="col-sm-12 col-xl-3">
								...
								<div class="col-sm-12 col-xl-3">
									...
									<select name="select" class="form-control form-control-sm" id="noticeType">
							...
							<div class="form-group row">
								<div class="col-sm-12 col-xl-3">
									...
									<p class="input_inline"><input class="form-control form-control-sm col-xl-6" type="date" id="noticeFrdatetime" onChange="javascript:inputDate($('#noticeFrdatetime').val(), $('#noticeTodatetime').val(), this)"> ~ <input class="form-control form-control-sm col-xl-6" type="date" id="noticeTodatetime" onChange="javascript:inputDate($('#noticeFrdatetime').val(), $('#noticeTodatetime').val(), this)">
									</p>
								</div>
								<div class="col-sm-12 col-xl-3">
