          ...
          <div class="card-block table-border-style">
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <button
                                        ...
                                        id="custRegSimple_custName_check"
                                      >
                                        중복확인
                                      </button>
                                    </td>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <input
                                        type="text"
                                        value=""
                                        id="custRegSimple_custMemerName"
                                        style="width: 100%"
                                    ...
                                    <td>
                                      <button
                                        ...
                                        id="custRegSimple_custName_register"
                                      >
                                        등록
                                      </button>
                                    </td>
                      ...
                      <div class="input-group input-group-sm mb-0">
                        ...
                        >
                          ...
                          <c:forEach var="row" items="${categoryList}">
                            <option data-no="${row.productNo}" value="${row.productCategoryName}">
            ...
            <div class="btn_wr text-right mt-3">
              ...
              <button
                ...
                onClick="javascript:location='${path}/product/list.do'"
              >
                목록
              </button>
              <button class="btn btn-md btn-primary" onClick="fn_productInsert()" value="등록">
                등록
              </button>
            </div>
          </div>
            ...
            if (data.code == 10001) {
              ...
              if (data.result1.length > 0) {
                ...
                for (var i = 0; i < tempArr.length; i++) {
                  html +=
                    "번호 : " + tempArr[i].custNo + " / 매출처 : " + tempArr[i].custName + "\n";
                }
              }
