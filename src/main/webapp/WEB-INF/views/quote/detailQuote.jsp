  ...
  <div class="row align-items-end">
    <div class="col-lg-12">
      <div class="page-header-title">
        <div class="d-inline">수주판매보고 조회</div>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="row">
    <div class="col-lg-12 col-xl-12">
      ...
      <ul class="nav nav-tabs tabs" role="tablist">
        ...
        <li class="nav-item">
          <a class="nav-link" data-toggle="tab" href="#tab02" role="tab">매입매출 내역</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" data-toggle="tab" href="#tab03" role="tab">견적 내역</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" data-toggle="tab" href="#tab04" role="tab">파일첨부</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" data-toggle="tab" href="#tab05" role="tab">기술지원 내역</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" data-toggle="tab" href="#tab06" role="tab">영업활동 내역</a>
        </li>
      </ul>
      <!-- Tab panes -->
                          ...
                          <td>
                            <div class="input-group input-group-sm mb-0">
                              <input
                                ...
                                readonly
                              />
                              <input type="hidden" name="buyrNo" id="buyrNo" value="" />
                              <span class="input-group-btn">
                                <button
                        ...
                        <tr>
                          ...
                          <td>
                            <span class="input_inline"
                              ...
                              form-control-sm" id="soppTargetAmt" name="soppTargetAmt" readonly
                              value="<fmt:formatNumber
                                value="${dto.soppTargetAmt}"
                                pattern="#,###"
                              />"></span
                            >원
                          </td>
                  ...
                  <c:forEach var="row" items="${dtodata01}">
                    <tr class="item1">
                      ...
                      <td style="text-align: right">
                        <fmt:formatNumber value="${row.dataNetprice}" pattern="#,###" />
                      </td>
                      <td style="text-align: right">
                        <fmt:formatNumber value="${row.dataQuanty}" pattern="#,###" />
                      </td>
                      <td style="text-align: right">
                        <fmt:formatNumber value="${row.dataAmt}" pattern="#,###" />
                      </td>
                      <td>${row.dataRemark}</td>
                      <td>
                        <button
                          id="inoutDelbtn"
                          onClick="javascript:fn_data01delete(${row.soppdataNo})"
                        >
                          삭제
                        </button>
                      </td>
            ...
            <div class="table-responsive">
                ...
                <tbody>
                  <c:forEach var="row2" items="${dtodata02}">
                    <tr class="item1">
                      ...
                      <td style="text-align: right">
                        <fmt:formatNumber value="${row2.dataNetprice}" pattern="#,###" />
                      </td>
                      <td style="text-align: right">
                        <fmt:formatNumber value="${row2.dataQuanty}" pattern="#,###" />
                      </td>
                      <td style="text-align: right">
                        <fmt:formatNumber value="${row2.dataAmt}" pattern="#,###" />
                      </td>
                      <td>${row2.dataRemark}</td>
                      <td>
                        <button
                          id="inoutDelbtn"
                          onClick="javascript:fn_data02delete(${row2.soppdataNo})"
                        >
                          삭제
                        </button>
                      </td>
              ...
              <div class="btn_wr text-right mt-3">
                <button
                  ...
                  onClick="javascript:location='${path}/sopp/list.do'"
                >
                  목록
                </button>
              </div>
...
<script>
  ...
  function fn_sopp2Aprv() {
    ...
    $.ajax({
      url: "${path}/sopp/insert2.do", // 클라이언트가 HTTP 요청을 보낼 서버의 URL 주소
