		...
		<div class="row">
			<div class="col-sm-12">
				...
				<div class="btn_wr text-right mt-3">
					...
					<button class="btn btn-md btn-success f-left modal-list-btn" onClick="javascript:location.href='${path}/sched/schedreport.do'">일정관리</button>
					<c:if test="${dto.userNo eq sessionScope.userNo || sessionScope.userRole eq 'ADMIN'}">
						...
						<button class="btn btn-md btn-inverse modal-list-btn" onClick="javascript:location='${path}/sched/schedreport.do'">취소</button>
					</c:if>
				</div>
			</div>
		</div>
