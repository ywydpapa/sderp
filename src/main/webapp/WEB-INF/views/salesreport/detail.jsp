  ...
  <div class="row align-items-end">
    <div class="col-lg-12">
      <div class="page-header-title">
        <div class="d-inline">판매보고 상세</div>
      </div>
    </div>
  </div>
</div>
          ...
          <table class="table table-sm bst02">
            ...
            <tbody>
              ...
              <tr>
                <th scope="row">내용</th>
                <td colspan="3">
                  <textarea name="contDesc" id="contDesc" rows="8" class="form-control">
${dto.contDesc}</textarea
                  >
                </td>
              </tr>
            </tbody>
...
<div class="btn_wr text-right mt-3">
  <button
    ...
    onClick="javascript:location='${path}/sreport/list.do'"
  >
    목록
  </button>
  <button class="btn btn-md btn-primary" onClick="fn_SaveCont()">계약등록</button>
  <button class="btn btn-md btn-inverse" onClick="javascript:location='${path}/sreport/list.do'">
    취소
  </button>
</div>
<!--//계약등록-->
