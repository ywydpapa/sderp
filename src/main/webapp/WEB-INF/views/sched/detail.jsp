		...
		<div class="row">
			<div class="col-sm-12">
							...
							<tbody>
								...
								<tr>
									...
									<td colspan="3">
										...
										<input class="form-control col-xl-2" type="date" id="schedFrom" value="${dto.schedFrom}" onChange="javascript:inputDate(setDateHourMinute($('#schedFrom').val(), $('#startTime').val()), setDateHourMinute($('#schedTo').val(), $('#endTime').val()),this)">
										...
										<input class="form-control col-xl-2" type="date" id="schedTo" value="${dto.schedTo}" onChange="javascript:inputDate(setDateHourMinute($('#schedFrom').val(), $('#startTime').val()), setDateHourMinute($('#schedTo').val(), $('#endTime').val()),this)">
				...
				<div class="btn_wr text-right mt-3">
					<button class="btn btn-md btn-success f-left modal-list-btn" onClick="javascript:location.href='${path}/sched/list.do'">목록</button>
