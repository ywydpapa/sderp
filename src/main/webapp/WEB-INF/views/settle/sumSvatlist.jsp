                    ...
                    <div class="table-responsive">
                    	...
                    	<table class="table table-striped table-bordered nowrap" style="margin-bottom: 1%;">
                    		<c:forEach items="${vatList}" var="vlist">
                            	...
                            	<c:set var="balanceSum" value="${balanceSum + ((vlist.custBalance + vlist.vatAmountS) - vlist.serialTotalS)}" />
                    		</c:forEach>
                    		<thead>
                    			<tr>
                            ...
                            <c:forEach items="${vatList}" var="vlist">
                                <tr>
                                    <td class="text-center">
                                   		<a data-remote="${path}/modal/popup.do?popId=custVatListModal&custNo=${vlist.custNo}&compNo=${sessionScope.compNo}&vatIssueDateFrom=${param.vatIssueDateFrom}&vatIssueDateTo=${param.vatIssueDateTo}&vatType=S" type="button" data-toggle="modal" data-target="#custVatList" style="cursor: pointer; text-decoration: underline;">
                                   			${vlist.vatBuyerName}
                                   		</a>
                                   	</td>
                                   	<td class="text-right">
