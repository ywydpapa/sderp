...
<div id="main_content">
                        ...
                        <table id="vatTableB" class="table table-striped table-bordered nowrap ">
                            ...
                            <c:forEach items="${vatList}" var="vlist">
                                <tr>
                                    ...
                                    <td class="text-center">
                                    	<a href="${path}/acc/vatHtml/${vlist.vatSerial}/${vlist.vatType}" onClick="javascript:popupVat(this); return false;">${vlist.vatSellerName}</a>
                                   	</td>
                                    <c:choose>
    ...
    <script>
        ...
        function fnListcon() {
    		...
    		var url = '${path}/acc/vatlistDocB.do'+param;
    		location.href = url;
    	}
