...
<nav>
	<ul class="pcoded-item pcoded-left-item">
		...
		<li class="pcoded-hasmenu pcoded <c:if test="${path2 eq '/sales/list.do' || path2 eq '/sales/list.do' || path2 eq '/sales/write.do' || path2 eq '/gw/estlist.do' || path2 eq '/gw/estwrite.do' || fn:startsWith(path2, '/sales/detail')}">pcoded-trigger</c:if>">
			<a href="javascript:void(0)">
				<span class="pcoded-micon">
