  ...
  <div id="main_content">
      ...
      <div class="row align-items-end">
        <div class="col-lg-12">
          <div class="page-header-title">
            <div class="d-inline">매입/매출 자료등록</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="btn_wr text-right mt-3">
      <button
        ...
        onClick="javascript:location='${path}/cont/iolist.do'"
      >
        자료목록
      </button>
      <!--<button class="btn btn-md btn-primary" onClick="fn_SaveContIO()">자료등록</button>-->
      <button class="btn btn-md btn-inverse" onClick="javascript:location='${path}/cont/iolist.do'">
        취소
      </button>
    </div>
    <!--//계약등록-->
