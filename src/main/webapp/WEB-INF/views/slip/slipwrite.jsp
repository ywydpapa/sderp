  ...
  <div id="main_content">
      ...
      <div class="row align-items-end">
        <div class="col-lg-12">
          <div class="page-header-title">
            <div class="d-inline">회계전표 등록</div>
          </div>
        </div>
      </div>
    </div>
                        ...
                        <form>
                          <div class="radio radio-inline">
                            <label style="margin-top: 10px">
                              <input type="radio" name="slipType" value="IN" checked="checked" />
                              <i class="helper"></i>입금전표</label
                            >
                          </div>
                          <div class="radio radio-inline">
                            <label>
                              <input type="radio" name="slipType" value="OUT" />
                              <i class="helper"></i>출금전표</label
                            >
                          </div>
                          <div class="radio radio-inline">
                            <label>
                              <input type="radio" name="slipType" value="CHG" />
                              <i class="helper"></i>대체전표</label
                            >
                          </div>
                        </form>
                      </div>
                      ...
                      <div class="input-group input-group-sm mb-0">
                        ...
                        <span class="input-group-btn">
                          <button
                            ...
                            type="button"
                            data-toggle="modal"
                            data-target="#acccdModal"
                          >
                            <i class="icofont icofont-search"></i>
                          </button>
                        </span>
                        <div class="modal fade" id="acccdModal" tabindex="-1" role="dialog">
              ...
              <table class="table table-sm bst02">
                ...
                <tbody>
                  <tr>
                    <td></td>
                    <td>
                      <select type="text" id="slineType" class="form-control">
                    ...
                    <td>
                      <select type="text" id="slineEvi" class="form-control">
                    ...
                    <td>
                      <button class="form-control" class="form-control" onClick="addSlipline()">
                        추가
                      </button>
                    </td>
                  </tr>
    ...
    <div class="btn_wr text-right mt-3">
      <button
        ...
        onClick="javascript:location='${path}/cont/sliplist.do'"
      >
        전표목록
      </button>
