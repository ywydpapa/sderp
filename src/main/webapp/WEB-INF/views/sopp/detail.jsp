							...
							<div class="row">
								<div class="col-sm-12">
									...
									<div class="btn_wr text-right mt-3" id="tab01_bottom">
										...
										<c:if test="${dto.userNo eq sessionScope.userNo && dto.soppStatus < '10181'}">
											...
											<button class="btn btn-md btn-danger" onClick="fn_Conthold()">진행보류(계약보류)</button>
										</c:if>
