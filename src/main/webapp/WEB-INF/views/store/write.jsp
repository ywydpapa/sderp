          ...
          <div class="card-block table-border-style">
                            ...
                            <div class="modal-content modal-80size">
                              ...
                              <div class="modal-body">
                                <div class="dt-responsive table-responsive">
                                  <div
                                    id="productdataTable2_wrapper"
                                    class="dataTables_wrapper dt-bootstrap4 no-footer"
                                  >
                                    <div class="row">
                                      <div class="col-xs-12 col-sm-12">
                                        <table
                                          id="productdataTable2"
                                          ...
                                          <thead>
                                            <tr role="row">
                                              ...
                                              <th
                                                class="sorting"
                                                tabindex="0"
                                                aria-controls="productdataTable2"
                                                rowspan="1"
                                                colspan="1"
            ...
            <div class="btn_wr text-right mt-3">
              ...
              <button
                ...
                onClick="javascript:location='${path}/store/listStore.do'"
              >
                목록
              </button>
              <button class="btn btn-md btn-primary" onClick="fn_storeInsert()" value="등록">
                등록
              </button>
            </div>
          </div>
        ...
        columnDefs: [
          {
            render: function (data, type, row) {
              ...
              return (
                '<a href="javascript:void(0);" onclick="fnSetproductdata2(' +
                row.productNo +
                ",'" +
                data +
                "'" +
