		...
		<div class="row align-items-end">
			<div class="col-lg-12">
				<div class="page-header-title">
					<div class="d-inline">기술지원 일정변경</div>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-sm-12">
				...
				<div class="btn_wr text-right mt-3">
					<button class="btn btn-md btn-success f-left modal-list-btn" onClick="javascript:location='${path}/sched/schedreport.do'">일정관리</button>
